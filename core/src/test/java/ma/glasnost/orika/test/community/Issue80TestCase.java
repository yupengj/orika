 ...
 *
 * <p>I define a class like this: public class JsonObject extends HashMap<String,Object>{...}. Orika
 * can not map JavaBean to JsonObject.
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/80">https://code.google.com/archive/p/orika/</a>
 */
public class Issue80TestCase {
  ...
  public void test() {
    ...
    factory
        .classMap(JsonObject.class, JavaBean.class)
        .field("name", "name")
        .field("id", "id")
        .register();
