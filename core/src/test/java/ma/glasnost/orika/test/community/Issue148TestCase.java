...
import ma.glasnost.orika.impl.generator.JaninoCompilerStrategy;
 ...
 *
 * <p>I am trying to map an object to a string via a custom converter, with the converter returning
 * null (e.g. because the source object is null)
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/148">https://code.google.com/archive/p/orika/</a>
 * @author dbb
 * @since 07.03.14
 */
public class Issue148TestCase {
  ...
  public static void init() {
    ...
    factoryBuilder.compilerStrategy(new JaninoCompilerStrategy());
  ...
  public static class Converter {
    ...
    public static class String2Object extends CustomConverter<String, WrapperObject> {
      public WrapperObject convert(
          String source, Type<? extends WrapperObject> destinationType, MappingContext context) {
        if (source == null) {
          return null;
        } else {
    ...
    public static class Object2String extends CustomConverter<WrapperObject, String> {
      public String convert(
          WrapperObject source, Type<? extends String> destinationType, MappingContext context) {
        if (source == null) {
          return null;
        } else {
          return source.getId();
