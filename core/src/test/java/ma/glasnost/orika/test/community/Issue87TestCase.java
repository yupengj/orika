 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/87">https://code.google.com/archive/p/orika/</a>
 */
public class Issue87TestCase {
  ...
  public void createMapperFactoryAndDefineMapping() {
    mapperFactory = new DefaultMapperFactory.Builder().useAutoMapping(false).build();
    mapperFactory
        .classMap(FakeBeanA.class, FakeBeanB.class)
  ...
  public void mapAbstractNestedPropertyWhenConcreteTypeIsRegistered() {
    ...
    mapperFactory.registerConcreteType(AbstractNestedType.class, NestedType.class);
  ...
  private void createAnInstanceOfFakeBeanAAndMapItToFakeBeanB() {
    ...
    FakeBeanB fakeBeanB = mapperFactory.getMapperFacade().map(fakeBeanA, FakeBeanB.class);
  ...
  public abstract static class AbstractNestedType {
