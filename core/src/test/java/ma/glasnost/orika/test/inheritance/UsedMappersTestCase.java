...
public class UsedMappersTestCase {
  ...
  public void testOneCallOfFieldMapping() {
    MapperFactory mapperFactory = MappingUtil.getMapperFactory();
    {
      mapperFactory.classMap(A.class, E.class).byDefault().register();
    }
    {
      mapperFactory.classMap(B.class, F.class).use(A.class, E.class).byDefault().register();
    }
  ...
  public void exclusionOnAbstractParent() throws Throwable {
    ...
    factory
        .classMap(Throwable.class, RuntimeException.class)
        .exclude("stackTrace")
        .favorExtension(true)
        .byDefault()
        .register();
    ...
    factory
        .classMap(UserUpdateException.class, UserRegistrationModelException.class)
        .byDefault()
        .register();

    UserUpdateException src = new UserUpdateException(true);
    UserRegistrationModelException dest =
        factory.getMapperFacade().map(src, UserRegistrationModelException.class);
