...
public class JavaDateApiTest {
    ...
    public void testJdk8Type_shouldBeImmutable() throws Exception {
        ...
        jdkClasses.addAll(Arrays.asList(Instant.class,Duration.class,LocalDate.class,LocalTime.class,LocalDateTime.class,ZonedDateTime.class,DayOfWeek.class,Month.class,MonthDay.class,OffsetDateTime.class,OffsetTime.class,Period.class,Year.class,YearMonth.class,ZoneOffset.class));
