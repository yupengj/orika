 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/138">https://code.google.com/archive/p/orika/</a>
 */
public class Issue138TestCase {
  ...
  public void test() {
    ...
    mapperFactory
        ...
        .fieldAToB("lastname", "backname")
        .fieldAToB("phones{number}", "phoneNumbers{}")
        .register();
  ...
  public void testBidirectional() {
    ...
    mapperFactory
        .classMap(Person1.class, Person2.class)
        .field("firstname", "forename")
        .field("lastname", "backname")
        .field("phones{number}", "phoneNumbers{}")
        .register();
