 ...
 *
 * @see <a
 *     href="https://github.com/orika-mapper/orika/issues/176">https://github.com/orika-mapper/orika/issues</a>
 */
public class Issue176WithSuperClassesTestCase {

  private static final ObjectFactory<B> OBJECT_FACTORY =
      new ObjectFactory<B>() {
  ...
  public void testIssue176_withSuperClasses() throws Exception {
    ...
    factory.registerObjectFactory(
        OBJECT_FACTORY, TypeFactory.valueOf(B.class), TypeFactory.valueOf(A.class));

    factory
        .classMap(A.class, B1.class)
        .field("x", "x1")
        .customize(
            new CustomMapper<A, B1>() {
  ...
  public void testIssue176_compinationOfSuperClassHirarchyAndObjectFactory() throws Exception {
    ...
    factory.classMap(AX.class, BX.class).field("y", "x3").byDefault().register();

    factory.classMap(A.class, B.class).byDefault().register();

    factory.classMap(ASuper.class, BSuper.class).byDefault().register();
  ...
  public void testIssue176_withSuperClassHirarchyOnly() throws Exception {
    ...
    factory.classMap(A.class, B1.class).field("x", "x1").byDefault().register();
