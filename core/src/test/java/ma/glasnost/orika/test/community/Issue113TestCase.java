 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/113">https://code.google.com/archive/p/orika/</a>
...
public final class Issue113TestCase {
  ...
  public void testIsAssignable() {
    ...
    Type<SourceBean<String>> sourceType = new TypeBuilder<SourceBean<String>>() {}.build();
