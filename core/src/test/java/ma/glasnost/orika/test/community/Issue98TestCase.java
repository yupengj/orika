 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/98">https://code.google.com/archive/p/orika/</a>
 */
public class Issue98TestCase {
  ...
  public void testMixedPaymentListMapping() throws Exception {
    ...
    for (PaymentDTO paymentDTO : dtos) {
      if (paymentDTO instanceof CardPaymentDTO) numCardPayments++;
      else if (paymentDTO instanceof CashPaymentDTO) numCashPayments++;
    }
  ...
  public abstract static class Payment implements Serializable {
    /** */
  ...
  public abstract static class PaymentDTO implements Serializable {
    /** */
    private static final long serialVersionUID = 1L;
  ...
  public class CustomMapper extends ConfigurableMapper {
    ...
    protected void configure(MapperFactory factory) {
      ...
      factory
          .classMap(CashPaymentDTO.class, CashPayment.class)
          .use(PaymentDTO.class, Payment.class)
          .byDefault()
          .register();

      factory
          .classMap(CardPaymentDTO.class, CardPayment.class)
          .use(PaymentDTO.class, Payment.class)
          .byDefault()
          .register();
    }
