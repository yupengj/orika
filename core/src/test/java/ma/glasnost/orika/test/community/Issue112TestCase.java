 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/112">https://code.google.com/archive/p/orika/</a>
...
public class Issue112TestCase {
  ...
  public void test() {
    ...
    mapperFactory
        .classMap(Class$1.class, Class$1Binding.class)
        .field("list{name}", "list{key}")
        .field("list{strings}", "list{value}")
        .byDefault()
        .register();

    BoundMapperFacade<Class$1, Class$1Binding> mapper =
        mapperFactory.getMapperFacade(Class$1.class, Class$1Binding.class);
    Class$1 inst =
        new Class$1(
            Arrays.asList(
                new Class_2("abc", Arrays.asList("qwe", "wer")),
                new Class_2("dfg", Arrays.asList("sdf", "cvb"))));
  ...
  public static class Class_2 {
    ...
    @Override
    public String toString() {
      return "Class$2{" + "name='" + name + '\'' + ", strings=" + strings + '}';
    }
  }
  ...
  public static class Class$1Binding {
    ...
    @Override
    public String toString() {
      return "Class$1Binding{" + "list=" + list + '}';
    }
  }
}
