...
/**
 * Want to have option to not set target object property when property value in the source object is
 * null.
 *
 * <p>
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/38">https://code.google.com/archive/p/orika/</a>
 */
public class Issue38TestCase {
  ...
  public void testAvoidEmptyObjectCreation() {
    ...
    factory.registerClassMap(
        factory.classMap(A.class, B.class).field("b.i1", "i1").field("b.i2", "i2").toClassMap());
