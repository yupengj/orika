 ...
 *
 * @see <a
 *     href="https://code.google.com/archive/p/orika/issues/44">https://code.google.com/archive/p/orika/</a>
 */
        ...
        new ConfigurableMapper() {
          ...
          protected void configure(MapperFactory factory) {
            factory
                ...
                .registerConverter(
                    "productToName",
                    new CustomConverter<List<Product>, List<String>>() {

                      public List<String> convert(
                          List<Product> source,
                          Type<? extends List<String>> destinationType,
        ...
        new ConfigurableMapper() {
          ...
          protected void configure(MapperFactory factory) {
            factory
                ...
                .registerConverter(
                    "productToName",
                    new CustomConverter<Product, String>() {
    ...
    ConfigurableMapper mapper =
        new ConfigurableMapper() {
          ...
          protected void configure(MapperFactory factory) {
            ...
            factory
                .classMap(Order.class, OrderDto2.class)
                .fieldMap("products", "productNames")
                .converter("productToName")
                .add()
                .register();
