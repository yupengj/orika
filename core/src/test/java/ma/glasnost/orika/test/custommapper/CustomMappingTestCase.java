...
public class CustomMappingTestCase {
  ...
  public void testCustomMapping() {
    ...
    factory
        .classMap(PersonDTO.class, Person.class)
        .customize(
  ...
  public void testCustomInheritedMapping() {
    ...
    factory
        .classMap(PersonDTO.class, Person.class)
        .customize(
            new CustomPersonMapper<PersonDTO>() {
              @Override
              public void mapBtoA(Person b, PersonDTO a, MappingContext context) {
                a.setName(b.getFirstName() + " " + b.getLastName());
              }
  ...
  public static class CustomCollectionWithWildcardsMapper
      extends CustomMapper<Collection<? super PersonDTO>, Collection<? extends Person>> {
    /* do nothing impl */
  }

  public static class CustomGenericCollectionMapper
      extends CustomMapper<Collection<PersonDTO>, Collection<Person>> {
    /* do nothing impl */
  }
  ...
  public static class CustomInheritedPersonMapper extends CustomPersonMapper<PersonDTO> {
    /* do nothing impl */
  }

  public static class CustomDeepInheritedPersonMapper extends CustomInheritedPersonMapper {
    /* do nothing impl */
  }
