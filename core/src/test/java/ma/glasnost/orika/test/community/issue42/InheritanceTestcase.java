...
public class InheritanceTestcase {
  ...
  public void testInheritance() {
    ...
    mapperFactory.registerClassMap(
        mapperFactory.classMap(BaseEntity.class, BaseEntityDto.class).byDefault().toClassMap());

    ClassMapBuilder<BaseUser, BaseUserDto> userClassMapBuilder =
        mapperFactory.classMap(BaseUser.class, BaseUserDto.class);
    userClassMapBuilder.customize(
        new CustomMapper<BaseUser, BaseUserDto>() {
          @Override
    ...
    mapperFactory.registerClassMap(
        userClassMapBuilder.use(BaseEntity.class, BaseEntityDto.class).byDefault().toClassMap());
