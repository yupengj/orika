...
public class CaseInsensitiveClassMapBuilderTest {
  ...
  @Test // issue 236
  public void maps_date_to_xml_gregorian_calendar_by_default_without_mapping_its_fields()
      throws Exception {
    MapperFactory factory =
        new DefaultMapperFactory.Builder()
            .classMapBuilderFactory(new CaseInsensitiveClassMapBuilder.Factory())
    ...
    factory.classMap(SourceDate.class, DestinationDate.class).byDefault().register();
