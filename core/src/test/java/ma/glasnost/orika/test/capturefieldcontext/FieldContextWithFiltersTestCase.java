...
public class FieldContextWithFiltersTestCase {
  ...
  /**
   * In this test, we demonstrate that the fully-qualified source path can be referenced to make a
   * filtering decision
   */
  @Test
  public void referenceFieldContextInFilters() throws Throwable {

    MapperFactory factory = new DefaultMapperFactory.Builder().captureFieldContext(true).build();
