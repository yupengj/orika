 ...
 *
 * @see <a
 *     href="https://github.com/orika-mapper/orika/issues/99">https://github.com/orika-mapper/orika/issues</a>
 */
public class Issue99Test {
  @Test
  public void testDateMapping() throws Exception {
    MapperFactory mapperFactory =
        new DefaultMapperFactory.Builder().mapNulls(false).useAutoMapping(false).build();
    ...
    mapperFactory
        ...
        .fieldMap("dateA1", "dateB1")
        .converter("yyyy-MM-dd")
        .add()
        .fieldMap("dateA2", "dateB2")
        .converter("yyyy-MM-dd kk:mm:ss")
        .add()
        .register();
