 ...
 * based on a provided date format pattern.<br>
 * <br>
...
public class DateToStringConverter extends BidirectionalConverter<Date, String> {
  ...
  /**
   * Constructs a new instance of DateToStringConverter capable of parsing and constructing Date
   * strings according to the provided format.
   *
   * @param format the format descriptor, processed according to the rules defined in {@link
