...
public class DateAndTimeConverters {
  ...
  public static boolean _polyCanConvert(Type<?> a, Type<?> b, Type<?> c, Type<?> d) {
    return (a.isAssignableFrom(c))
        && (!d.getRawType().equals(Object.class) && d.isAssignableFrom(b));
  }
  ...
  public static class TimestampToCalendarConverter
    ...
    public Calendar convertTo(
        Timestamp source, Type<Calendar> destinationType, MappingContext context) {
      return toCalendar(source.getTime());
    }

    @Override
    public Timestamp convertFrom(
        Calendar source, Type<Timestamp> destinationType, MappingContext context) {
  ...
  public static class TimeToSqlDateConverter
      extends BuiltinBidirectionalConverter<Time, java.sql.Date> {

    @Override
    public java.sql.Date convertTo(
        Time source, Type<java.sql.Date> destinationType, MappingContext context) {
      return new java.sql.Date(source.getTime());
    }

    @Override
    public Time convertFrom(
        java.sql.Date source, Type<Time> destinationType, MappingContext context) {
  ...
  public static class TimestampToTimeConverter
    ...
    @Override
    public Timestamp convertFrom(
        Time source, Type<Timestamp> destinationType, MappingContext context) {
  ...
  public static class TimestampToSqlDateConverter
      extends BuiltinBidirectionalConverter<Timestamp, java.sql.Date> {

    @Override
    public java.sql.Date convertTo(
        Timestamp source, Type<java.sql.Date> destinationType, MappingContext context) {
      return new java.sql.Date(source.getTime());
    }

    @Override
    public Timestamp convertFrom(
        java.sql.Date source, Type<Timestamp> destinationType, MappingContext context) {
      return new Timestamp(source.getTime());
    }
  }
  ...
  public static class DateToSqlDateConverter
      extends BuiltinBidirectionalConverter<Date, java.sql.Date> {

    @Override
    public java.sql.Date convertTo(
        Date source, Type<java.sql.Date> destinationType, MappingContext context) {
      return new java.sql.Date(source.getTime());
    }

    @Override
    public Date convertFrom(
        java.sql.Date source, Type<Date> destinationType, MappingContext context) {
  ...
  public static class XmlGregorianCalendarToSqlDateConverter
    ...
    @Override
    public java.sql.Date convertTo(
        XMLGregorianCalendar source, Type<java.sql.Date> destinationType, MappingContext context) {
      return new java.sql.Date(toLong(source));
    }

    @Override
    public XMLGregorianCalendar convertFrom(
        java.sql.Date source, Type<XMLGregorianCalendar> destinationType, MappingContext context) {
      return toXMLGregorianCalendar(source.getTime(), factory);
    }
  ...
  public static class XmlGregorianCalendarToTimeConverter
    ...
    @Override
    public Time convertTo(
        XMLGregorianCalendar source, Type<Time> destinationType, MappingContext context) {
      return new Time(toLong(source));
    }

    @Override
    public XMLGregorianCalendar convertFrom(
        Time source, Type<XMLGregorianCalendar> destinationType, MappingContext context) {
      return toXMLGregorianCalendar(source.getTime(), factory);
    }
  ...
  public static class CalendarToSqlDateConverter
      extends BuiltinBidirectionalConverter<Calendar, java.sql.Date> {

    @Override
    public java.sql.Date convertTo(
        Calendar source, Type<java.sql.Date> destinationType, MappingContext context) {
      return new java.sql.Date(toLong(source));
    }

    @Override
    public Calendar convertFrom(
        java.sql.Date source, Type<Calendar> destinationType, MappingContext context) {
      return toCalendar(source);
    }
  }
  ...
  public static class CalendarToTimeConverter
    ...
    @Override
    public Calendar convertFrom(
        Time source, Type<Calendar> destinationType, MappingContext context) {
      return toCalendar(source);
    }
  }
  ...
  public static class DateToXmlGregorianCalendarConverter
    ...
    @Override
    public XMLGregorianCalendar convertTo(
        Date source, Type<XMLGregorianCalendar> destinationType, MappingContext context) {
      return toXMLGregorianCalendar(source, factory);
    }

    @Override
    public Date convertFrom(
        XMLGregorianCalendar source, Type<Date> destinationType, MappingContext context) {
      return toDate(source);
    }
  ...
  public static class CalendarToXmlGregorianCalendarConverter
    ...
    @Override
    public XMLGregorianCalendar convertTo(
        Calendar source, Type<XMLGregorianCalendar> destinationType, MappingContext context) {
      return toXMLGregorianCalendar(source, factory);
    }

    @Override
    public Calendar convertFrom(
        XMLGregorianCalendar source, Type<Calendar> destinationType, MappingContext context) {
      return toCalendar(source);
    }
  ...
  public static class LongToSqlDateConverter
    ...
    @Override
    public java.sql.Date convertTo(
        Long source, Type<java.sql.Date> destinationType, MappingContext context) {
      return new java.sql.Date(source);
    }

    @Override
    public Long convertFrom(
        java.sql.Date source, Type<Long> destinationType, MappingContext context) {
      return toLong(source);
    }
  }
  ...
  public static class LongToXmlGregorianCalendarConverter
    ...
    @Override
    public XMLGregorianCalendar convertTo(
        Long source, Type<XMLGregorianCalendar> destinationType, MappingContext context) {
      return toXMLGregorianCalendar(source, factory);
    }

    @Override
    public Long convertFrom(
        XMLGregorianCalendar source, Type<Long> destinationType, MappingContext context) {
      return toLong(source);
    }
  ...
  public static class LongToTimestampConverter
    ...
    @Override
    public Timestamp convertTo(
        Long source, Type<Timestamp> destinationType, MappingContext context) {
  ...
  public static class XmlGregorianCalendarToTimestampConverter
    ...
    @Override
    public Timestamp convertTo(
        XMLGregorianCalendar source, Type<Timestamp> destinationType, MappingContext context) {
      return new Timestamp(toLong(source));
    }

    @Override
    public XMLGregorianCalendar convertFrom(
        Timestamp source, Type<XMLGregorianCalendar> destinationType, MappingContext context) {
      return toXMLGregorianCalendar(source, factory);
    }
  ...
  public static class DateToTimestampConverter
    ...
    @Override
    public Timestamp convertTo(
        Date source, Type<Timestamp> destinationType, MappingContext context) {
      return new Timestamp(toLong(source));
    }
