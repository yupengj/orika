...
/**
 * PassThroughConverter allows configuration of a number of specific types which should be passed
 * through (as-is) without creating a mapped copy.<br>
 * <br>
 * This allows you to declare your own set of types which should be treated by Orika as if they were
 * in the set of immutable types.
 *
...
public class PassThroughConverter extends CustomConverter<Object, Object> {
  ...
  /**
   * Constructs a new PassThroughConverter configured to treat the provided list of types as
   * immutable.
   *
  ...
  public PassThroughConverter(java.lang.reflect.Type... types) {
    StringBuilder desc =
        new StringBuilder(PassThroughConverter.class.getSimpleName() + "(Copy by reference:");
    String separator = "";
