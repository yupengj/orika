...
public final class OrikaSystemProperties {
  ...
  /**
   * Specifies whether .java source files should be written for generated objects; valid choices are
   * "true" or "false". <br>
   * Any non-null value will be evaluated to "false"; if this property is not specified, default
   * behavior is determined by the compiler strategy.<br>
   * <br>
  ...
  /**
   * Specifies the output location where source files should be written (if writing source files is
   * enabled). This defaults to the value "classpath:/ma/glasnost/orika/generated/", which signals
   * to write the files to the location "/ma/glasnost/orika/generated/" relative to the root of the
   * class-path.<br>
  ...
  /**
   * Specifies whether class files should be written for generated objects; valid choices are "true"
   * or "false". <br>
   * Any non-null value will be evaluated to "false"; if this property is not specified, default
   * behavior is determined by the compiler strategy.<br>
   * <br>
  ...
  /**
   * Specifies the output location where class files should be written (if writing class files is
   * enabled). This defaults to the value "classpath:/ma/glasnost/orika/generated/", which signals
   * to write the files to the location "/ma/glasnost/orika/generated/" relative to the root of the
   * class-path.<br>
  ...
  /**
   * Specifies the fully-qualified class name of the compiler strategy to use when creating
   * generated objects; default value is determined by the MapperFactory implementation.
   */
  public static final String COMPILER_STRATEGY = "ma.glasnost.orika.compilerStrategy";
  /**
   * Specifies the fully-qualified class name of the un-enhancement strategy to use when performing
   * type lookup in order to map objects; <br>
  ...
  /**
   * Specifies the fully-qualified class name of the constructor-resolver strategy to use when
   * resolving constructors for instantiation of target types; <br>
   * <br>
   * default value is determined by the MapperFactory implementation.
   */
  public static final String CONSTRUCTOR_RESOLVER_STRATEGY =
      "ma.glasnost.orika.constructorResolverStrategy";
  /**
   * Specifies the fully-qualified class name of the property-resolver strategy to use when
   * resolving mappable properties of target types; <br>
   * <br>
  ...
  public static final String PROPERTY_RESOLVER_STRATEGY =
      "ma.glasnost.orika.propertyResolverStrategy";
  /**
   * Specifies the fully-qualified class name of the classmap builder factory be used by the default
   * mapper factory to generate new ClassMapBuilder instances. <br>
   * <br>
  ...
  /**
   * Specifies the fully-qualified class name of the MappingContextFactory to be used by the default
   * mapper factory to generate new MappingContext instances. <br>
   * <br>
  ...
  /**
   * Specifies the fully-qualified class name of the converter factory to use when generating
   * converters for target types;<br>
   * <br>
   * default value is determined by the MapperFactory implementation.
   */
  public static final String CONVERTER_FACTORY = "ma.glasnost.orika.converterFactory";
  /**
   * Specifies that the new mapping strategy cache should be used to cache mapping strategies;<br>
   * <br>
   * default value is <code>false</code>
   */
  public static final String USE_STRATEGY_CACHE = "ma.glasnost.orika.useStrategyCache";
  /** Specifies whether null values should be mapped. default value is <code>true</code> */
  public static final String MAP_NULLS = "ma.glasnost.orika.mapNulls";
  /** Specifies whether to use built-in converters default value is <code>true</code> */
  ...
  /**
   * Specifies whether the current state of the core mapping objects should be printed to the log
   * upon an exception.
   *
  ...
  /**
   * Specifies a default value for the 'favorExtension' option on registered class-maps when a value
  ...
  /**
   * Specifies a default value for the 'captureFieldContext' option on the DefaultMapperFactory; if
   * <code>true</code>, the result is that the following calls will return a meaningful value,
   * relative to the currently mapped source and destination fields:
   *
   * <ul>
