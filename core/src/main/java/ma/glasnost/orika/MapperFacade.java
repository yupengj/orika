...
/**
 * The main runtime interface between a Java application and Orika. This is the central interface
 * abstracting the service of a Java bean mapping. <br>
 * <br>
 * The main operation of <code>MapperFacade</code> is <code>map()</code> that copy from a deeply
 * structured one object to an other.<br>
 * <br>
 * MapperFacade manages the state of a mapping operation through MappingContext.<br>
 * The operation of mapping may include : <br>
 *
 * <ul>
 *   <li>Creation of new objects : <code>newObject()</code>
 *   <li>Conversion object to another type: <code>convert()</code>
 *   <li>Mapping recursively an object to an other class : <code>map()</code>
 * </ul>
 *
 * <br>
 * Example of code to map an instance of <code>Entity</code>(<code>entity</code> ) to <code>DTO
 * </code> class:<br>
 *
 * <pre>
 * ...
...
public interface MapperFacade {
  ...
  /**
   * Create and return a new instance of type D mapped with the properties of <code>sourceObject
   * </code>.
   *
   ...
   * <code>sourceType</code> and <code>destinationType</code> to specify the parameterized types of
   ...
   * @return a new Set containing elements of type <code>destinationClass</code> mapped from the
   *     elements of <code>source</code>.
   */
   ...
   * @param source the Iterable from which to map
   * @param destinationClass the type of elements to be contained in the returned Set.
   * @return a new List containing elements of type <code>destinationClass</code> mapped from the
   *     elements of <code>source</code>.
   */
   ...
   * @param source the Array from which to map
   * @param destinationClass the type of elements to be contained in the returned Set.
   * @return a new Array containing elements of type <code>destinationClass</code> mapped from the
   *     elements of <code>source</code>.
   */
   ...
   */
  <S, D> void mapAsCollection(
      S[] source, Collection<D> destination, Class<D> destinationClass, MappingContext context);
  ...
  /**
   * Maps the source Iterable into a new Set parameterized by <code>destinationType</code>.
   *
   * @param source the Iterable from which to map
   * @param sourceType the type of the source elements
   * @param destinationType the type of the new object to return
   * @return a new Set containing elements of type <code>destinationType</code> mapped from the
   *     elements of <code>source</code>.
   */
  ...
  /**
   * Maps the source Array into a new Set parameterized by <code>destinationType</code>.
   *
   * @param source the Array from which to map
   * @param sourceType the type of the source elements
   * @param destinationType the type of the new object to return
  ...
  /**
   * Maps the source Iterable into a new List parameterized by <code>destinationType</code>.
   *
   * @param source the Iterable from which to map
   * @param sourceType the type of the source elements
   * @param destinationType the type of the new object to return the current mapping context
   * @return a new List containing elements of type <code>destinationType</code> mapped from the
   *     elements of <code>source</code>.
   */
  ...
  /**
   * Maps the source Array into a new List parameterized by <code>destinationType</code>.
   *
   * @param source the Array from which to map
   * @param sourceType the type of the source elements
   * @param destinationType the type of the new object to return
   ...
   * @param sourceType the type of the source elements
   * @param destinationType the type of the new object to return
   * @return the destination Array mapped from the elements of <code>source</code>.
   */
  <S, D> D[] mapAsArray(
   ...
   * @param converterId the specific converter to use; if null, the first compatible global
   *     converter is used
   * @return an instance of the converted destination type
   */
  <S, D> D convert(
      S source, Class<D> destinationClass, String converterId, MappingContext mappingContext);
   ...
   */
  <Sk, Sv, Dk, Dv> Map<Dk, Dv> mapAsMap(
      Map<Sk, Sv> source,
   ...
   * @return a new List instance, with element types as defined by destinationType
   */
  <Sk, Sv, D> List<D> mapAsList(
   ...
   * @param destinationType the parameterized type of the destination Set elements
   * @param context the current mapping context
   * @return a new Map instance, with element types as defined by destinationType
   */
  <Sk, Sv, D> Set<D> mapAsSet(
      Map<Sk, Sv> source,
      Type<? extends Map<Sk, Sv>> sourceType,
  ...
  /**
   * Create new instance of a destination class. <strong>Abstract types are unsupported</code>.
   *
   ...
   * @param mapInPlace whether the strategy should map objects in-place
   * @param context the current MappingContext
   * @return a MappingStrategy appropriate for mapping between the provided types
   */
  <S, D> MappingStrategy resolveMappingStrategy(
      final S sourceObject,
      final java.lang.reflect.Type sourceType,
      final java.lang.reflect.Type destinationType,
      boolean mapInPlace,
