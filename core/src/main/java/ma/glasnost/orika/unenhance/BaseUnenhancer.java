...
/**
 * Provides a delegating unenhance strategy which also post-processes the unenhancement results
 * using the associated super-type strategies.<br>
...
public class BaseUnenhancer implements UnenhanceStrategy {
  ...
  private final LinkedList<UnenhanceStrategy> unenhanceStrategyChain =
      new LinkedList<UnenhanceStrategy>();
  private final LinkedList<SuperTypeResolverStrategy> supertypeStrategyChain =
      new LinkedList<SuperTypeResolverStrategy>();
