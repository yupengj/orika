...
/**
 * MappingStrategy defines the contract for a pre-resolved classification of mapping which may be
 * cached for quick lookup based on raw inputs.
 */
public interface MappingStrategy extends MappedTypePair<Object, Object> {
   ...
   * @param destinationObject the pre-instantiated destination object onto which properties should
  ...
  /**
   * MappingStrategyKey defines the minimum information necessary to cache a particular mapping
   * strategy
   */
  final class Key {
    ...
    public boolean equals(Object obj) {
      ...
      Key other = (Key) obj;
      if (destinationProvided != other.destinationProvided) return false;
      if (getDestinationType() == null) {
        if (other.destinationType != null) return false;
      } else if (!destinationType.equals(other.destinationType)) return false;
      if (getRawSourceType() == null) {
        if (other.rawSourceType != null) return false;
      } else if (!rawSourceType.equals(other.rawSourceType)) return false;
