...
public class ClassMapBuilderForMaps<A, B> extends ClassMapBuilder<A, B> {
   ...
   * @param defaults
   */
  protected ClassMapBuilderForMaps(
      Type<A> aType,
      Type<B> bType,
  ...
  /**
   * Test whether the provided type is the special case type for this Builder (as in, not the
   * standard Java Bean type)
   *
   * @param type
   ...
   */
  public ClassMapBuilderForMaps<A, B> byDefault(
  ...
  protected Property resolveCustomProperty(String expr, Type<?> propertyType) {
    ...
    return new MapKeyProperty(
        expr, mapAncestor.getNestedType(0), mapAncestor.getNestedType(1), null);
  }
  ...
  public static class Factory extends ClassMapBuilderFactory {
    ...
    protected <A, B> ClassMapBuilder<A, B> newClassMapBuilder(
      ...
      return new ClassMapBuilderForMaps<A, B>(
