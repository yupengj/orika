...
/**
 * Property is an immutable representation of an accessor/mutator pair (either of which may be null)
 * that is used to generate code needed to copy data from one type to another.
 */
public class Property {
  ...
  /** @return the path to this property; properties in the path are ordered from parent to child */
  public Property[] getPath() {
    return EMPTY_PATH;
  }

  /**
   * @return the container for this property; null unless the property represents an element of a
   *     multi-occurrence property
   */
  ...
  public static class Builder {
    ...
    public Builder merge(final Property property) {
      ...
      if (elementType == null
          || (property.elementType != null && elementType.isAssignableFrom(property.elementType))) {
        elementType = property.elementType;
      }
      if (propertyType == null
          || (property.type != null && propertyType.isAssignableFrom(property.type))) {
    ...
    public Property build(final PropertyResolver propertyResolver) {
      ...
      Property p =
          new Property(
              expression != null ? expression : name,
              name,
              getter,
              setter,
              propertyType,
    ...
    private void validate(final PropertyResolver propertyResolver) {
      ...
      if (getterMethod == null && setterMethod == null && getter == null && setter == null) {
        throw new IllegalArgumentException(
            "property "
                + (owningType != null ? owningType.getCanonicalName() : "")
                + "["
                + name
                + "]"
        ...
        if (propertyResolver != null && getterMethod != null && this.propertyType == null) {
          this.propertyType =
              propertyResolver.resolvePropertyType(
                  getterMethod, null, owningType.getRawType(), owningType);
        }
        ...
        if (setterMethod != null && setterMethod.getParameterTypes().length != 1) {
          throw new IllegalArgumentException(
              "writeMethod ("
                  ...
                  + ") for "
                  + owningType.getCanonicalName()
                  + "["
                  + name
                  + "] does not have exactly 1 input argument ");
        }

        if (getterMethod != null
            && (getterMethod.getReturnType() == null
                || getterMethod.getReturnType().equals(Void.TYPE)
                || getterMethod.getReturnType().equals(Void.class))) {
          throw new IllegalArgumentException(
              "readMethod ("
