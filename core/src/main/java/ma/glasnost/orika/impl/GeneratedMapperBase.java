...
public abstract class GeneratedMapperBase extends GeneratedObjectBase
  ...
  /**
   * Returns true if <code>usedMapper</code> is found within the usedMapper hierarchy of <code>
   * ofMapper</code>.
   *
   ...
   * @return
   */
  public static boolean isUsedMapperOf(
      Mapper<Object, Object> usedMapper, Mapper<Object, Object> ofMapper) {
    return (ofMapper instanceof GeneratedMapperBase
        && ((GeneratedMapperBase) ofMapper).uses(usedMapper));
  }
  ...
  public static boolean isUsedMappersInitialized(Mapper<Object, Object> mapper) {
    return (mapper instanceof GeneratedMapperBase
        && ((GeneratedMapperBase) mapper).getUsedMappers() != null);
  }
  ...
  /**
   * Returns true if this mapper (or any of it's usedMappers, recursively) makes use of the
   * specified mapper.
   *
   * @param mapper
   * @return
  ...
  public String toString() {
    ...
    return "GeneratedMapper<"
        ...
        + "> {"
        + "usedConverters: "
        + Arrays.toString(usedConverters)
        + ", "
        + "usedMappers: "
        + Arrays.toString(usedMappers)
        + ", "
        + "usedMapperFacades: "
        + Arrays.toString(usedMapperFacades)
        + ", "
        + "usedTypes: "
        + Arrays.toString(usedTypes)
        + " }";
  }
}
