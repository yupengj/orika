...
public abstract class UseCustomMapperStrategy extends AbstractMappingStrategy {
   ...
   * @param unenhancer
   */
  public UseCustomMapperStrategy(
  ...
  public Object map(
      final Object sourceObject, final Object destinationObject, final MappingContext context) {
  ...
  /**
   * Gets an instance of the destination object to be mapped; may return the provided
   * destinationObject for map-in-place scenarios
   *
   * @param sourceObject
