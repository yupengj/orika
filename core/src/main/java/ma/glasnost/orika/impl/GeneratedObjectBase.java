...
public abstract class GeneratedObjectBase {
  ...
  protected void mapArray(
      byte[] destination, List<Object> source, Class<?> clazz, MappingContext mappingContext) {
    if (source == null) {
      return;
    }
  ...
  protected void mapArray(
      boolean[] destination, List<Object> source, Class<?> clazz, MappingContext mappingContext) {
    if (source == null) {
      return;
    }
  ...
  protected void mapArray(
      char[] destination, List<Object> source, Class<?> clazz, MappingContext mappingContext) {
    if (source == null) {
      return;
    }
  ...
  protected void mapArray(
      short[] destination, List<Object> source, Class<?> clazz, MappingContext mappingContext) {
    if (source == null) {
      return;
    }
  ...
  protected void mapArray(
      int[] destination, List<Object> source, Class<?> clazz, MappingContext mappingContext) {
    if (source == null) {
      return;
    }
  ...
  protected void mapArray(
      long[] destination, List<Object> source, Class<?> clazz, MappingContext mappingContext) {
    if (source == null) {
      return;
    }
  ...
  protected void mapArray(
      float[] destination, List<Object> source, Class<?> clazz, MappingContext mappingContext) {
    if (source == null) {
      return;
    }
  ...
  protected void mapArray(
      double[] destination, List<Object> source, Class<?> clazz, MappingContext mappingContext) {
    if (source == null) {
      return;
    }
